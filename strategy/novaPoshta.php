...
class novaPoshta implements iSend {
    public function delivery($weight,$price) {
        ...
        if ($price > 10000)
            return 'Обрано спосіб отримання товару у відділенні Нової пошти.' . ' Вітаємо! У вас безкоштовна доставка, тому що вартість вашого замовлення перевищує 10 000 грн.' . " Загальна вартість до оплати $price грн. " ;
        else {
